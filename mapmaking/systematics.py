...
class QubicTDFullBand(QubicPolyAcquisition):

    def __init__(self, d, Nsub, Nrec=1, comp=[], nu_co=None, H=None):
        ...
        self.allnus = np.array(list(allnus150))
    ...
    def get_operator(self, fwhm=None):
    ...
    def get_invntt_operator(self):
        ...
        return BlockDiagonalOperator([invn150], axisout=0)
...
class OtherDataParametric:
    ...
    def get_noise(self, seed=None, fact=None, seenpix=None):
        ...
        np.random.set_state(state)
        return R2tod(out)
class JointAcquisitionFrequencyMapMakingTD:

    def __init__(self, d, Nrec, Nsub, H):

        self.d = d
        self.Nrec = Nrec
        self.Nsub = Nsub
        #self.qubic = qubic
        self.qubic = QubicTDFullBand(self.d, comp=[], Nsub=self.Nsub, Nrec=self.Nrec, H=H)
    ...
    def get_invntt_operator(self, weight_planck=1, beam_correction=None, seenpix=None, mask=None):
        ...
        #print(self.qubic.get_invntt_operator())
